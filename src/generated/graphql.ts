...
export type AllAdventuresQuery = { __typename?: 'Query', getAdventures: Array<{ __typename?: 'Adventure', _id: string, campaignId: string, name: string, description: string | null, status: AdventureStatus, createdAt: string, updatedAt: string } | null> | null };
...
export type AdventureByIdQuery = { __typename?: 'Query', getAdventure: { __typename?: 'Adventure', _id: string, campaignId: string, name: string, description: string | null, status: AdventureStatus, createdAt: string, updatedAt: string } | null };
...
export type SaveAdventureMutation = { __typename?: 'Mutation', saveAdventure: { __typename?: 'Adventure', _id: string, campaignId: string, name: string, description: string | null, status: AdventureStatus, createdAt: string, updatedAt: string } | null };
