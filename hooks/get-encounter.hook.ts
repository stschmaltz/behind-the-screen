...
import { EncounterByIdResponse, encounterByIdQuery } from "../data/graphql/snippets/encounter";
import { Encounter } from "../types/encounters";
import { useQuery } from "./use-async-query";

function getEncounter(id: string): { encounter: Encounter | null; loading: boolean } {
