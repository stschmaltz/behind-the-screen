...
export type GetUserPreferencesQuery = {
  ...
  getUserPreferences: {
    ...
    theme: string | null;
    hasRequestedMoreUses: boolean | null;
    aiGenerationUsageCount: number | null;
  } | null;
};
...
export type IncrementAiGenerationUsageMutationVariables = Exact<{
  [key: string]: never;
}>;

export type IncrementAiGenerationUsageMutation = {
  __typename?: 'Mutation';
